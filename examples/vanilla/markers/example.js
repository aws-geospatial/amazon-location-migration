...
function initMap() {
  ...
  const blueHeartImg = "../../shared/images/blue_heart.png";
  new google.maps.Marker({
  ...
  const yellowSquareImg = "../../shared/images/yellow_square.png";
  new google.maps.Marker({
  ...
  pinkStarImg.src = "../../shared/images/pink_star.png";
