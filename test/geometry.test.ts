...
describe("MigrationEncoding", () => {
  ...
  test("should encode path from MVCArray", () => {
    ...
    const encoded = MigrationEncoding.encodePath(mvcArray as any);
    expect(typeof encoded).toBe("string");
    expect(encoded.length).toBeGreaterThan(0);
  });
});
...
describe("MigrationPoly", () => {
  test("should detect point inside polygon", () => {
    ...
    const result = MigrationPoly.containsLocation(pointInside, mockPolygon as any);
  ...
  test("should detect point outside polygon", () => {
    ...
    const result = MigrationPoly.containsLocation(pointOutside, mockPolygon as any);
  ...
  test("should detect point on polyline edge", () => {
    ...
    const result = MigrationPoly.isLocationOnEdge(pointOnLine, polyline as any);
  ...
  test("should detect point near polyline edge with tolerance", () => {
    ...
    const result = MigrationPoly.isLocationOnEdge(pointNearLine, polyline as any, 0.001);
  ...
  test("should detect point not on polyline edge", () => {
    ...
    const result = MigrationPoly.isLocationOnEdge(pointNotOnLine, polyline as any);
